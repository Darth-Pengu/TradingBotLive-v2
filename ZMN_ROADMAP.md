...
|---|---|---|---|
| 2026-04-20 | Session 3 | Sell-path devnet validation + PumpPortal Local spec audit (Verdict B: spec matches code; 261 historical HTTP 400s are condition-specific). Phase 2 blocked (faucet + structural URL hardcoding). No code change. | (this commit) |
