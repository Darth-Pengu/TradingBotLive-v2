...
|---|---|---:|---|
| Trading | `4h4pstXd5JtQuiFFSiLyP5DWWdpaLJAMLNzKwfoii8xJ` | **5.064095633 SOL** | 2026-06-08 13:00 UTC via Helius `getBalance` (topped up from 0.064; pre-V5A top-up DONE; on-chain == Redis == LIVE_ONCHAIN snapshot) |
