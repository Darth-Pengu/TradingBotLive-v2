...
async def paper_sell(
    ...
    if trade_id:
        ...
        # Distinct param slots ($11-$13) for corrected_* — asyncpg's prepared
        # statement protocol can't deduce a single type when the same parameter
        # appears in columns of different declared types (outcome=varchar vs
        # corrected_outcome=text). Hotfix 2026-04-30 after first attempt threw
        ...
        await pg_pool.execute(
            """UPDATE paper_trades SET exit_price=$1, exit_time=$2, hold_seconds=$3,
               ...
               corrected_pnl_sol=$11, corrected_pnl_pct=$12, corrected_outcome=$13,
